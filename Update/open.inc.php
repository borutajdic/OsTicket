  ...
  <table width="800" cellpadding="1" cellspacing="0" border="0">
	...
	<!-- dodal sam -->
		<div class="form-group">   
					<label class="required" for="deptId"><?php echo __('Izberi oddelek');?><sup class="error">*</sup></label>		
					<select id="deptId" name="deptId">				
						<option value="" selected="selected" >&mdash;<?php echo __('Izberi oddelek');?>&mdash;</option>
						<?php
