...
?>
	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			...
			<div class="form-group">
			<!-- <<code>> -->			
				<button type="submit" class="btn btn-success"><i class="fa fa-check"></i><?php echo __('Update'); ?></button>
				<button type="reset" class="btn btn-default"><i class="fa fa-refresh"></i><?php echo __('Reset'); ?></button>
				<button type="button" onclick="javascript: window.location.href='index.php';" class="btn btn-default"><i class="fa fa-times"></i><?php echo __('Cancel'); ?>  </button>
			<!-- <<code>> -->
			</div>
			<!-- /.form-group -->
