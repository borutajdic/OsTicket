...
define('SECRET_SALT','SueJH0JbCEVKQGoOQECxhol80RwIJsIS');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','borut.ajdic@3tav.si');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','192.168.210.37:3306');
define('DBNAME','osticket1');
define('DBUSER','dbadmin');
define('DBPASS','Letaliska32_Ljubljana');
