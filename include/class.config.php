...
class OsticketConfig extends Config {
	...
	/* <<code>> */
	function isCreateTicketOffline() {
        return !$this->isCreateTicketEnabled();
    }

    function isCreateTicketOnline() {
        return $this->isCreateTicketEnabled();
    }
	
	 function isCreateTicketEnabled() {
        return ($this->get('iscreateticketenabled'));
    }
	/* <<code>> */
    ...
    function updateSystemSettings($vars, &$errors) {
        ...
        return $this->updateAll(array(
			...
			/* <<code>> */
			'iscreateticketenabled'=>$vars['iscreateticketenabled'],
			/* <<code>> */
