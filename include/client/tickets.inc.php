	...
	<div class="row">
		<div class="col-sm-5">
			<div class="form-group">
                <input class="form-control" type="text" name="q" size="20" value="<?php echo Format::htmlchars($_REQUEST['q']); ?>" placeholder="<?php echo __('Keyword Search');?>">
            </div>
            <!-- /.form-group -->
		</div>
	    <!-- /.col -->
	    ...
	    <!-- /.col -->
	    <div class="col-sm-3">
			<input class="btn btn-primary" type="submit" value="<?php echo __('Go');?>"> <a class="refresh btn" href="<?php echo Format::htmlchars($_SERVER['REQUEST_URI']); ?>"><i class="fa fa-refresh"></i> <?php echo __('Refresh'); ?></a>
		</div>
	    <!-- /.col -->
	</div>
	<!-- /.row -->
