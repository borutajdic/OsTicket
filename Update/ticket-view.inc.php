...
<ul id="threads">
	...
	<li><a class="" id="toggle_time_thread" href="#"><?php echo __('Porabljen čas'); ?></a></li>
</ul>
<br>
...
<div id="response_options">
    <ul class="tabs">
		...
		<?php
        if($thisstaff->canPostReply()) { ?>
		<li><a id="time_tab" href="#add_time"><?php echo __('Dodaj čas');?></a></li>
		<?php
        } ?>
    </ul>
    <?php
...
?>
	...
	<!--moja koda dodaten zahvihek za dodajanje casa-->
		...
		<table style="width:100%" border="0" cellspacing="0" cellpadding="3">
			<tr>
				...
				<td>
					...
					<input type="text" name="time_spent" size="5" value="<?php if(isset($_POST['time_spent'])) echo $_POST['time_spent'];?>"
				</td>
            </tr>
			<tr>
				<td>
					...
					<select name="job">
						<?php
						$dbquery="SELECT opis,id FROM ost_vrsta_dela";
